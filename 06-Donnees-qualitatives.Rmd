...
-   Être capable de remanier des tableaux de données de long en large ou inversément et de fusionner plusieurs tableaux
...
[^06-donnees-qualitatives-6]: Les analyses métagénomiques coûtent très cher. Il est souvent impossible de faire des réplicats. Un seul échantillon d'ADN a donc été séquencé ici pour chaque communauté.
