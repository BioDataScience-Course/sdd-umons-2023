...
L'ensemble de vos réponses sont collectées et utilisées afin de construire la note finale. Il n'est donc plus nécessaire de passer un examen classique en session d'examen. Tous ces exercices prouvent que vous avez acquis ou non les acquis d'apprentissage de ce cours. Cependant, vous aurez des **interrogrations** classiques régulières sur la matière vue jusque là.
...
-   [Plan du cours de Science des données biologiques I : années 2023-2024](https://github.com/BioDataScience-Course/BioDataScience-Common/tree/2023-2024/docs/plan_de_cours/sdd1_plan_cours_2023-2024.md)
...
## Déroulement du cours {#temps .unnumbered}

Le cours est divisé en 12 modules. Comme expliqué précédemment, les exercices et les projets de niveau 1 à 3 ont pour objectif de vous préparer aux exercices plus complexes. Vous réaliserez ces exercices dans chaque module de ce cours.
...
![](images/sdd1_00/sdd1_q1_orga.drawio.png)

Pour le second quadrimestre

![](images/sdd1_00/sdd1_q2_orga.drawio.png)
